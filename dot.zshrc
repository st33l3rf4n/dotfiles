...
alias ec2ssh="ssh -i ~/.ssh/sentrana_primary.pem -l ec2-user"
alias ubuntussh="ssh -i ~/.ssh/sentrana_primary.pem -l ubuntu"
...
DEFAULT_USER="anthony.difrancesco"
#source /usr/local/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh

fpath=(/usr/local/share/zsh/site-functions $fpath)

# The next line updates PATH for the Google Cloud SDK.
if [ -f /Users/anthony.difrancesco/google-cloud-sdk/path.zsh.inc ]; then
  source '/Users/anthony.difrancesco/google-cloud-sdk/path.zsh.inc'
fi

# The next line enables shell command completion for gcloud.
if [ -f /Users/anthony.difrancesco/google-cloud-sdk/completion.zsh.inc ]; then
  source '/Users/anthony.difrancesco/google-cloud-sdk/completion.zsh.inc'
fi
...
alias gitmeHome="git config user.email acdifran@gmail.com"
alias gitmeWork="git config user.email anthony.difrancesco@sentrana.com"

ssh-add ~/.ssh/sentrana_id_rsa

# heroku autocomplete setup
HEROKU_AC_BASH_SETUP_PATH=/Users/anthony.difrancesco/Library/Caches/heroku/autocomplete/bash_setup && test -f $HEROKU_AC_BASH_SETUP_PATH && source $HEROKU_AC_BASH_SETUP_PATH;